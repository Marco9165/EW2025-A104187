    ...
    for (let i = 0; i < slist.length; i++) {
        pagHTML += `
                <tr>
                    ...
                    <td>
                        <a href="${slist[i].git}" target="_blank">${slist[i].git}</a>
                    </td>
                    <td>
                        <a href="/alunos/edit/${slist[i].id}" style="text-decoration: none;">✏️</a>
                        <a href="/alunos/delete/${slist[i].id}" style="text-decoration: none; margin-left: 10px;">❌</a>
                    </td>
                </tr>
        `;
    }
...
exports.studentFormEditPage = function(a, d) {
    ...
    // Verifica e exibe os checkboxes dos TPCs
    for (let i = 1; i <= 8; i++) {
        let tpcKey = `tpc${i}`;
        let checked = a[tpcKey] === "1" ? "checked" : "";
        pagHTML += `
...
exports.studentPage = function(aluno, d) {
    ...
    // Verifica e exibe os TPCs
    for (let i = 1; i <= 8; i++) {
        let tpcKey = `tpc${i}`;
        if (aluno[tpcKey] === "1") {
            pagHTML += `<li><b>TPC${i}</b>: Feito</li>`;
        } else {
            pagHTML += `<li><b>TPC${i}</b>: Não feito</li>`;
        }
    }
